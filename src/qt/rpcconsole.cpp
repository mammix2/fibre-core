    ...
    historyPtr(0)
{
    ...
    if (isfDark == 1) {
        ...
        ui->isFibreDark->setChecked(true);
        ui->isFibreDark->setText("Connected over FibreDark 'Tor' only!");
    }
...
void RPCConsole::clear()
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
                ...
                "td.cmd-request { color: #e86941; } "
                "td.cmd-error { color: red; } "
                "b { color: #e86941; } "
                );

    message(CMD_REPLY, (tr("Welcome to the Fibre RPC console.") + "<br>" +
