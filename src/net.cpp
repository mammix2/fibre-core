...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fibre " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetOnionSeed[][1] = {
    ...
    {"vo4yqcijvxifzcd2.onion"},
    {"zuavvfbulorde7cy.onion"},
    {"5bvxl376owodw33q.onion"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fibre is probably already running."), addrBind.ToString().c_str());
        else
